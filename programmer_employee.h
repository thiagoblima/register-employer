...
programmer::p_lang_level &programmer::getProgrammerLevel() {
    ...
    std::cin >> t;
    switch(t){
        case programmer::p_lang_level::JUNIOR     : std::cout << t << " - Junior dev \n"  ; break;
        case programmer::p_lang_level::FULL       : std::cout << t << " - Full dev \n"    ; break;
        case programmer::p_lang_level::SENIOR     : std::cout << t << " - Senior dev \n" ; break;
        case programmer::p_lang_level::ARCHITECT  : std::cout << t << " - Architect dev \n" ; break;
        case programmer::p_lang_level::ENGINEER   : std::cout << t << " - Engineer dev \n" ; break;
        default:  std::cout << "you MUST select a programmer level\n";
    }
}
...
programmer::p_lang_role &programmer::getProgrammerRole() {
    ...
    std::cin >> t;
    switch(t){
        case programmer::p_lang_role::FRONTEND   : std::cout << t << " - FrontEnd dev \n"  ; break;
        case programmer::p_lang_role::BACKEND    : std::cout << t << " - BackEnd dev \n"    ; break;
        case programmer::p_lang_role::FULLSTACK  : std::cout << t << " - Fullstack dev \n" ; break;
        default:  std::cout << "you MUST select a programmer role\n";
    }
}
...
programmer::p_lang_back_end &programmer::getProgrammerLangBackEnd() {
    ...
    std::cin >> t;
    switch(t){
        case programmer::p_lang_back_end::JAVA         : std::cout << t << " - Java dev \n"  ; break;
        case programmer::p_lang_back_end::PHP          : std::cout << t << " - PHP dev \n"    ; break;
        case programmer::p_lang_back_end::RUBYONRAILS  : std::cout << t << " - Ruby On Rails dev \n" ; break;
        case programmer::p_lang_back_end::C            : std::cout << t << " - C dev \n" ; break;
        case programmer::p_lang_back_end::CPP          : std::cout << t << " - C++ dev \n" ; break;
        case programmer::p_lang_back_end::CSharp       : std::cout << t << " - C# dev \n" ; break;
        case programmer::p_lang_back_end::VB           : std::cout << t << " - VB dev \n" ; break;
        case programmer::p_lang_back_end::NODE         : std::cout << t << " - Nodejs dev \n" ; break;
